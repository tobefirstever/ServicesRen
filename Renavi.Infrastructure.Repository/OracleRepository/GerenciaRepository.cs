...
namespace Renavi.Infrastructure.Repository.OracleRepository
{
    public class GerenciaRepository : IGerenciaRepository
    {
        ...
        public GerenciaRepository(IConnectionFactory connectionFactory)
        {
        ...
        public async Task<IEnumerable<GerenciaEntity>> GetList()
        {
            using (var conexion = _connectionFactory?.GetConnection())
            {
                ...
                return await conexion.QueryAsync<GerenciaEntity>("PKGSTP_GARANTIA_CS_JOSE.SPRNSTP_PORTALFMV3", param: dynamicParameters, commandType: CommandType.StoredProcedure);
            }
