    ...
    public class GeneralRepository : IGeneralRepository
    {
        ...
        public async Task<IEnumerable<GeneralEntity>> GetList()
        {
            using (var conexion = _connectionFactory?.GetConnection())
            {
                ...
                return await conexion.QueryAsync<GeneralEntity>("PKGSTP_GARANTIA_CS_JOSE.SPRNSTP_PORTALFMV3", param: dynamicParameters, commandType: CommandType.StoredProcedure);
            }
        }
    }
}
