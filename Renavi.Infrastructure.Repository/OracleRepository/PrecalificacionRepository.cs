    ...
    public class PrecalificacionRepository : IPrecalificacionRepository
    {
        ...
        public async Task<IEnumerable<PrecalificacionEntity>> GetList()
        {
            using (var conexion = _connectionFactory?.GetConnection())
            {
                ...
                return await conexion.QueryAsync<PrecalificacionEntity>("PKGSTP_GARANTIA_CS_JOSE.SPRNSTP_PORTALFMV3", param: dynamicParameters, commandType: CommandType.StoredProcedure);
            }
        }
    }
}
